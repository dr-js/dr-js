import { fromString, toString, fromNodejsBuffer } from 'source/common/data/ArrayBuffer.js'
...
const parseBufferPacket = (bufferPacket) => {
  ...
  const headerString = toString(fromNodejsBuffer(bufferPacket.slice(HEADER_BYTE_SIZE, HEADER_BYTE_SIZE + headerSize)))
