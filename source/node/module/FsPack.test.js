...
before(async () => {
  ...
  await resetDirectory(fromRoot('input'))
  ...
  await resetDirectory(fromRoot('input/dir0'))
  ...
  await resetDirectory(fromRoot('input/dir1'))
  if (process.platform !== 'win32') {
    await resetDirectory(fromRoot('input/dir2'))
