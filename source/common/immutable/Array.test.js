import { strictEqual, notDeepEqual } from 'assert'
import {
  arraySet,
  arrayDelete,
  arrayInsert,
...
describe('Common.Immutable.Array', () => {
  ...
  it('should pass arraySet()', () => {
    ...
    notDeepEqual(arraySet(ARRAY_DATA, 0, 'b'), ARRAY_DATA)
  ...
  it('should pass arrayDelete()', () => {
    ...
    notDeepEqual(arrayDelete(ARRAY_DATA, 0), ARRAY_DATA)
    strictEqual(arrayDelete(ARRAY_DATA, 0)[ 0 ], SAMPLE_ARRAY)
  })
  it('should pass arrayInsert()', () => {
    notDeepEqual(arrayInsert(ARRAY_DATA, 0, 'I'), ARRAY_DATA)
    notDeepEqual(arrayInsert(ARRAY_DATA, 1, 'I'), ARRAY_DATA)
    notDeepEqual(arrayInsert(ARRAY_DATA, 2, 'I'), ARRAY_DATA)
  ...
  it('should pass arrayMove()', () => {
    ...
    notDeepEqual(arrayMove(ARRAY_DATA, 0, 1), ARRAY_DATA)
    notDeepEqual(arrayMove(ARRAY_DATA, 1, 0), ARRAY_DATA)
  ...
  it('should pass arrayPush()', () => {
    notDeepEqual(arrayPush(ARRAY_DATA, 'I'), ARRAY_DATA)
    strictEqual(arrayPush(ARRAY_DATA, 'I')[ 2 ], 'I')
  })
  it('should pass arrayUnshift()', () => {
    notDeepEqual(arrayUnshift(ARRAY_DATA, 'I'), ARRAY_DATA)
    strictEqual(arrayUnshift(ARRAY_DATA, 'I')[ 0 ], 'I')
  })
  it('should pass arrayPop()', () => {
    notDeepEqual(arrayPop(ARRAY_DATA), ARRAY_DATA)
    strictEqual(arrayPop(ARRAY_DATA)[ 0 ], 'a')
    notDeepEqual(arrayPop(ARRAY_DATA)[ 0 ], SAMPLE_ARRAY)
    notDeepEqual(arrayPop(ARRAY_DATA)[ 1 ], SAMPLE_ARRAY)
    strictEqual(arrayPop(ARRAY_DATA).length, 1)
  })
  it('should pass arrayShift()', () => {
    notDeepEqual(arrayShift(ARRAY_DATA), ARRAY_DATA)
    strictEqual(arrayShift(ARRAY_DATA)[ 0 ], SAMPLE_ARRAY)
    notDeepEqual(arrayShift(ARRAY_DATA)[ 0 ], 'a')
    notDeepEqual(arrayShift(ARRAY_DATA)[ 1 ], 'a')
  ...
  it('should pass arrayConcat()', () => {
    ...
    notDeepEqual(arrayConcat(ARRAY_DATA, [ 1 ]), ARRAY_DATA)
  ...
  it('should pass arrayMatchPush()', () => {
    ...
    notDeepEqual(arrayMatchPush(ARRAY_DATA, 1), ARRAY_DATA)
    notDeepEqual(arrayMatchPush(ARRAY_DATA, [ 1 ]), ARRAY_DATA)
  ...
  it('should pass arrayMatchDelete()', () => {
    notDeepEqual(arrayMatchDelete(ARRAY_DATA, 'a'), ARRAY_DATA)
    notDeepEqual(arrayMatchDelete(ARRAY_DATA, SAMPLE_ARRAY), ARRAY_DATA)
  ...
  it('should pass arrayMatchMove()', () => {
    notDeepEqual(arrayMatchMove(ARRAY_DATA, 1, 'a'), ARRAY_DATA)
    notDeepEqual(arrayMatchMove(ARRAY_DATA, 2, 'a'), ARRAY_DATA)
  ...
  it('should pass arrayFindPush()', () => {
    notDeepEqual(arrayFindPush(ARRAY_DATA, (v) => v === 'F', 'F'), ARRAY_DATA)
    notDeepEqual(arrayFindPush(ARRAY_DATA, (v) => false, 'F'), ARRAY_DATA)
  ...
  it('should pass arrayFindDelete()', () => {
    ...
    notDeepEqual(arrayFindDelete(ARRAY_DATA, (v) => v === 'a'), ARRAY_DATA)
    notDeepEqual(arrayFindDelete(ARRAY_DATA, (v) => true), ARRAY_DATA)
  ...
  it('should pass arrayFindMove()', () => {
    ...
    notDeepEqual(arrayFindMove(ARRAY_DATA, (v) => v === 'a', 2), ARRAY_DATA)
    notDeepEqual(arrayFindMove(ARRAY_DATA, (v) => true, 2), ARRAY_DATA)
  ...
  it('should pass arrayFindSet()', () => {
    ...
    notDeepEqual(arrayFindSet(ARRAY_DATA, (v) => v === 'a', 'F'), ARRAY_DATA)
    notDeepEqual(arrayFindSet(ARRAY_DATA, (v) => true, 'F'), ARRAY_DATA)
