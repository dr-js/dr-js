...
describe('ImmutableOperation:object', () => {
...
describe('ImmutableOperation:array', () => {
  ...
  it('should pass arrayInsert()', () => {
    ...
    nodeModuleAssert.notStrictEqual(arrayInsert(ARRAY_DATA, 6, 'I'), ARRAY_DATA)
    ...
    nodeModuleAssert.strictEqual(arrayInsert(ARRAY_DATA, 6, 'I')[ 2 ], 'I')
    nodeModuleAssert.notStrictEqual(arrayInsert(ARRAY_DATA, 6, 'I')[ 6 ], 'I')
    nodeModuleAssert.strictEqual(arrayInsert(ARRAY_DATA, 0, 'I')[ 0 ], 'I')
    nodeModuleAssert.strictEqual(arrayInsert(ARRAY_DATA, -1, 'I')[ 0 ], 'I')
    nodeModuleAssert.notStrictEqual(arrayInsert(ARRAY_DATA, -1, 'I')[ -1 ], 'I')
  })
  ...
  it('should pass arrayMatchMove()', () => {
    ...
    nodeModuleAssert.strictEqual(arrayMatchMove(ARRAY_DATA, -1, 'a'), arrayMatchMove(ARRAY_DATA, 0, 'a'))
